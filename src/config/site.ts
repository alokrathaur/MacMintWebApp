...
export const SITE_CONFIG = {
  ...
  downloadUrl: "https://github.com/alokrathaur/MacMintWebApp/releases/download/v1.0.3/MacMint.dmg",
  directDmgUrl: "/MacMint.dmg",
  directPkgUrl: "/MacMint.pkg",
  previousDmgUrl: "/MacMint-1.0.2.dmg",
  ...
  pricing: {
    ...
    proLifetime: {
      ...
      description: "Pay once, own forever. Full access for 1 Mac device.",
